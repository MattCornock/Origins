...
date: 2026-09-25
tags: [places, food, melbourne, ratings]
type: log
status: active
---
...
A running log of places we've visited, with ratings so we can pick better spots next time.

## Rating rubric

Each visit gets scored the morning after:
...
| Value | 1–5 |
| Service | 1–5 |
| Would go back? | Yes / Maybe / No |
| What we ordered | free text |
| Standout / skip | the best thing and the one to avoid |
| Good for | e.g. date night, after dinner, with mates, quick bite |
...
### Cuppa Turca — 2026-09-25

- **Address:** 262 High St, Northcote VIC 3070
- **What it is:** Turkish dessert bar known for künefe and dondurma (stretchy Turkish ice cream, made fresh daily, vegan options available). Floor seating with cushions and mosaic tiles.
